	...
	<section :class="componentName">
		<div class="sw">
			...
			<section :class="componentName + '-carousel'">
				<article v-for="(post, index) in blog" :class="{ 'active' : currentSlide === index }" class="col-4 blog-card">
			...
			return {
				blog: [
					...
					{	
						...
						page_slug: "easy-car-buying-with-the-new-autostore-website",
						page_title: "5 Easy Car Buying Easy Car Buying Easy Car Buying",
						published_at: {
							date: "2019-01-10 14:56:00.000000"
						}
					}
