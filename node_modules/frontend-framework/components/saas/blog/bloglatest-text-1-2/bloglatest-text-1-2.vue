	...
	<section :class="componentName">
		<div class="sw">
			...
			<section :class="componentName + '-carousel'">
				<article v-for="(post, index) in blog" class="col-3 blog-card">
...
<script>
	export default {
		name: 'Bloglatest-text-1-2',
		props: {
			componentName: {
				default: 'bloglatest-text-1-2',
				type: String
			}
		},
		data() {
			return {
				...
				blog: [
					{	
						...
						page_title: "Easy Car Buying with the New Autostore Website!",
						published_at: {
					...
					{	
						...
						page_slug: "easy-car-buying-with-the-new-autostore-website",
						page_title: "Easy Car Buying with the New Autostore Website New Autostore Website! ",
						published_at: {
							date: "2019-01-10 14:56:00.000000"
						}
					},
