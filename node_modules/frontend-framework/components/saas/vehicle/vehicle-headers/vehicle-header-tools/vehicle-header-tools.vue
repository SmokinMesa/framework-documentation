	...
	<section :class="[componentName, { 'showing-modal' : isEnlarged }]"> 
		<div class="vehicle-tools">
			<div class="share-compare">
				<a class="favourite" href="#" title="Add this vehicle to your favourites"><span hidden>Favourite this vehicle</span>
					<icon-favourite />
				</a>
				<a class="compare" href="#" title="Compare this vehicle"><span hidden>Compare this vehicle</span>
					<icon-compare />
				</a>
				<a class="share" href="#" title="Share this vehicle"><span hidden>Share this vehicle</span>
					<icon-share />
				</a>
			</div>

			<a v-if="vehicle.media_urls.length" class="enlarge" href="#" @click="toggleEnglarge()"><span hidden>Enlarge images</span>
				<icon-enlarge />
			</a>
		</div>
		...
		<article class="sw content">
			...
			<div class="col-4 vehicle-price-container">
				...
				<div class="vehicle-price-monthly">
					<p v-if="hasFinance" class="price">[£pm]<span class="pcm">pcm</span></p>
