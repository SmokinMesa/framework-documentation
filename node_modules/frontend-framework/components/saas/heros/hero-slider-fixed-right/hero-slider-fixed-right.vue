...
<script>
	export default {
		name: 'HeroSliderFixedRight',	
		props: {
			componentName: {
				default: 'hero-slider-fixed-right',
				type: String
			},
			slides: {
				default: () => [
					{
						imgUrl: "https://images.unsplash.com/photo-1519557489688-c30c74763166?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80",
						imgAlt: "Image 1 alt text",
						content: '<h1>Welcome to Superbad Cars</h1>',
						component: null
					},
					{
						imgUrl: "https://images.unsplash.com/photo-1471174617910-3e9c04f58ff5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80",
					...
					{
						imgUrl: "https://images.unsplash.com/photo-1534644162040-964a1b93d02f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1490&q=80",
						imgAlt: "Image 4 alt text",
						content: '<h1>Join our mailing list</h1><br>',
						component: 'widget-newsletter'
					}
				],
				type: Array
			},
