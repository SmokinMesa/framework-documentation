<template>
	<header :id="componentName">
		...
		<div class="header-bottom">
			...
			<button class="no-style mobile-nav-toggle" :class="{ 'close': isNavVisible }" @click="toggleNavVisible()">
			...
			<nav :class="{ 'active' : isNavVisible }">
				...
				<div v-if="needsOverflowNav" class="overflow-nav-toggle">
					<ul class="overflow-nav">
						<li v-for="nav in navOverflow"><a :class="{ 'dropdown' : nav.children.length }" :href="nav.url" :title="nav.name">{{ nav.name }}</a>
							<ul v-if="nav.children.length" class="nested-nav">
